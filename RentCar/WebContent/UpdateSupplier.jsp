...
<body>
	...
	<%
		String SuppID = (String) request.getParameter("SuppID");

	GetSupplier gs = new GetSupplier();

	Suppliermodel sm = gs.get_values_from_Supplier(SuppID);
	%>
	...
	<div class="container">
		<form action="UpdateSupplier?SuppID=<%=sm.getSuppID()%>" method="post">
			<div class="row">
				<div class="col-25">
				...
				<div class="col-75">
					<input type="text" id="fname" name="fullname"
						placeholder="Your name.." value="<%=sm.getName()%>" required>
				</div>
			</div>
			<div class="row">
				<div class="col-25">
			...
			<div class="row">
				...
				<div class="col-75">
					<input type="text" id="vehiclename" name="vehiclename"
						placeholder="Vehicle name.." value="<%=sm.getVeh_name()%>"
						required>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-75">
					<input type="text" id="modulenum" name="moduleNum"
						placeholder="module Number..." value="<%=sm.getVeh_mod()%>"
						required>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-75">
					<input type="text" id="conNumber" name="ContactNumber"
						placeholder="mobile.." pattern="[0-9]{3} [0-9]{4} [0-9]{3}"
						value="<%=sm.getContactno()%>" required>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-75">
					<input type="Number" id="paymentamt" name="payamt"
						placeholder="Rs.xxxxx.../=" value="<%=sm.getPay_amt()%>" required>
				</div>
			</div>
