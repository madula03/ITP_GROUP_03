...
<body>
	...
	<div class="diform">
		<form action="AddCustServlet" method="post" id="add">
			...
			<br> 
			<input type="text" id="nic" name="NIC" placeholder="0000000000" pattern="[0-9]{9}[vV]{1}" required>
			<br> 
			
			<label for="lno">License Number</label> 
			<br> 
			<input type="text" id="lno" name="LicenseNum" placeholder="License Number" required> 
			<br>
			
			<label for="end date">License End Date</label> 
			<br> 
			<input type="date" id="end" name="LicenseEndDate" placeholder="Date" required>
			<br> 
