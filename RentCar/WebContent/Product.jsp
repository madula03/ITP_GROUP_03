...
<div class="container mt-5">
	<div class="card">
		...
		<div class="col-md-5">
			...
			<h6 class="caption-title-sub">Start from 30$/per a day</h6><hr>
			...
			<div class="col-md-3">
                                ...
                                <span class="car-details-price">
                                	<h2 class=""> <small>&nbsp; </small> </h2>
									 <h2><small>LKR</small> 18,753 <br></h2>
                                    <span>LKR   2,679 X 7</span>
 								</span>

                                <div class="clearfix"></div>
                             
                                <br>
								<a   href="AddCustomerDetails.jsp" class="btn btn-lg btn-secondary pull-right" onclick="submitBookingForm('SD','18753', '18753','Suzuki Alto 800', '26', '700', '110')">Book Now</a>
...
<div class="card mt-4">
		...
		<div class="col-md-5">
			...
			<h6 class="caption-title-sub">Start from 34$/per a day</h6><hr>
				<div class="caption-text">
...
<div class="card mt-4">
		...
		<div class="col-md-5">
			...
			<h6 class="caption-title-sub">Start from 39$/per a day</h6><hr>
				<div class="caption-text">
				Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean nec eros. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia.</div>
			</div>
