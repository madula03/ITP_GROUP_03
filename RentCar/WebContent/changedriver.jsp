...
Driver address<input type= "text" name="address"value = "${driver.address}"><br>
Driver mobile<input type= "text" name="mobile"value = "${driver.mobile}"><br>
last trip charge(paid)<input type= "text" name="tripsalary"value = "${driver.tripsalary}"><br>
total trip salary(to be paid)<input type= "text" name="netsalary"value = "${driver.netsalary}"><br>
